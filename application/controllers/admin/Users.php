...
class Users extends Admin_Controller {
	...
	public function create()
	{
		...
		/* Validate form input */
		$this->form_validation->set_rules('nik', 'lang:users_nik', 'required|is_numeric|is_unique['.$tables['users'].'.username]');
		...
		$this->form_validation->set_rules('place_of_birth', 'lang:users_place_of_birth', 'required');
		$this->form_validation->set_rules('date_of_birth', 'lang:users_date_of_birth', 'required');
		$this->form_validation->set_rules('address', 'lang:users_address', 'required');
		$this->form_validation->set_rules('gender', 'lang:users_gender', 'required');
		$this->form_validation->set_rules('religion', 'lang:users_religion', 'required');
		$this->form_validation->set_rules('marital_status', 'lang:users_marital_status', 'required');
		...
		else
		{
			...
			$this->data['place_of_birth'] = array(
                ...
                'class' => 'form-control',
				'value' => $this->form_validation->set_value('place_of_birth'),
			);
	...
	public function edit($id)
	{
		...
		$this->form_validation->set_rules('place_of_birth', 'lang:edit_user_validation_place_of_birth_label', 'required');
		$this->form_validation->set_rules('date_of_birth', 'lang:edit_user_validation_date_of_birth_label', 'required');
		$this->form_validation->set_rules('address', 'lang:users_address', 'required');
		$this->form_validation->set_rules('gender', 'lang:users_gender', 'required');
		$this->form_validation->set_rules('religion', 'lang:users_religion', 'required');
		$this->form_validation->set_rules('marital_status', 'lang:users_marital_status', 'required');
		...
		$this->data['place_of_birth'] = array(
			...
			'class' => 'form-control',
			'selected' => $this->form_validation->set_value('place_of_birth', $user->place_of_birth)
		);
		$this->data['date_of_birth'] = array(
			'name'  => 'date_of_birth',
			'id'    => 'date_of_birth',
		...
		$this->data['gender'] = array(
			...
			'class' => 'form-control',
			'selected' => $this->form_validation->set_value('gender', $user->gender)
		);
		$this->data['religion'] = array(
			'name'  => 'religion',
			'id'    => 'religion',
			...
			'class' => 'form-control',
			'selected' => $this->form_validation->set_value('religion', $user->religion)
		);
		$this->data['marital_status'] = array(
			'name'  => 'marital_status',
			'id'    => 'marital_status',
			...
			'class' => 'form-control',
			'selected' => $this->form_validation->set_value('marital_status', $user->marital_status)
		);
		$this->data['address'] = array(
			'name'  => 'address',
			'id'    => 'address',
