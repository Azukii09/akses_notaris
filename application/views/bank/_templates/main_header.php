...
?>
            <header class="main-header">
                <a href="<?php echo site_url('bank/dashboard'); ?>" class="logo">
                <span class="logo-mini"><b><?php echo $title_mini ?></b></span>
                    <span class="logo-lg"><b><?php echo $title_lg ?></b></span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('bank/users/profile'); ?>" class="btn btn-default btn-flat"><?php echo lang('header_profile'); ?></a>
                                        </div>
