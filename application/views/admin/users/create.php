                             ...
                             <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                            <?php echo lang('users_nik', 'first_name', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <?php echo lang('users_place_of_birth', 'place_of_birth', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_dropdown($place_of_birth);?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php echo lang('users_date_of_birth', 'date_of_birth', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_input($date_of_birth);?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php echo lang('users_gender', 'gender', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <?php echo lang('users_address', 'address', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_input($address);?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php echo lang('users_religion', 'religion', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_dropdown($religion);?>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <?php echo lang('users_marital_status', 'marital_status', array('class' => 'col-sm-2 control-label')); ?>
                                            <div class="col-sm-10">
                                                <?php echo form_dropdown($marital_status);?>
                                            </div>
                                        </div>
                                        <div class="form-group">
