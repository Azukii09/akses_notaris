...
?>
                                                ...
                                                <td>
                                                    <?php echo anchor('admin/users/edit/'.$user->id, '<span class="label label-primary">'.lang('actions_edit').'</span>'); ?>
                                                    <?php echo anchor('admin/users/profile/'.$user->id, '<span class="label label-warning">'.lang('actions_see').'</span>'); ?>
                                                </td>
                                            </tr>
<?php endforeach;?>
                                        </tbody>
