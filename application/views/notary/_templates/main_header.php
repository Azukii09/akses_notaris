...
?>
            <header class="main-header">
                ...
                <span class="logo-mini"><b><?php echo $this->ion_auth->get_users_groups()->row()->name ?></b></span>
                    <span class="logo-lg"><b><?php echo $this->ion_auth->get_users_groups()->row()->name ?></b></span>
                </a>
                            ...
                            <li class="dropdown user user-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        ...
                                        <p><?php echo $user_login['username']; ?><small><?php echo lang('header_member_since'); ?> <?php echo date('d-m-Y', $user_login['created_on']); ?></small></p>
                                    </li>
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('notary/users/profile'); ?>" class="btn btn-default btn-flat"><?php echo lang('header_profile'); ?></a>
                                        </div>
