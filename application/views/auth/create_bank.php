...
?>
<div id="message"></div>
<?php echo form_open_multipart(current_url(), array('class' => 'form-horizontal', 'id' => 'form-create_bank')); ?>
<h2>Registrasi Rekanan</h2>
<div class="form-group">
	 ...
	 <?php //echo lang('users_motto', 'motto', array('class' => 'col-sm-2 control-label')); ?>
            <div class="col-sm-6">
      ...
      <script>
            $(function () {
                  $('#form-create_bank').on('submit', function (e) {

                        e.preventDefault();
                        var formData = new FormData(this);

                        $.ajax({
                              url: '<?php echo base_url();?>auth/create_bank',
                              type: 'POST',
                              data: formData,
                              cache: false,
                              contentType: false,
